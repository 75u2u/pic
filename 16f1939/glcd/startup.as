	...
	; Microchip MPLAB XC8 C Compiler V1.37
	...
	; Compiler options:
	;
	; -oglcd.cof -mglcd.map --summary=default --output=default glcd.p1 \
	; i2c.p1 main.p1 --chip=16F1939 -P --runtime=default --opt=default \
...
;Stack space: 0201Ah-023EFh (982 bytes)
...
;	STVREN = OFF, Stack Overflow or Underflow will not cause a Reset
...
;	VCAPEN = 0x3, unprogrammed default
