	...
	; Compiler options:
	;
	; -omoter.cof -mmoter.map --summary=default --output=default adc.p1 \
	; main.p1 pwm.p1 --chip=16F1827 -P --runtime=default --opt=default \
...
;Stack space: 0201Dh-0216Fh (339 bytes)
...
;	PLL Enable
;	PLLEN = 0x1, unprogrammed default
