...
#define TURRETRIGHT	LATB2=1;	SetPWM2(1023); 		//砲塔右へ
#define TURRETLEFT	LATB2=0;	SetPWM2(1023);		//砲塔左へ
#define TIRERIGHT	LATB3=1;	SetPWM1(1023);		//タイヤ右回転
#define TIRELEFT	LATB3=0;	SetPWM1(1023);		//タイヤ左回転
#define FIRE		LATB6=1;						//発射
#define AIRSTOP		LATB6=0;						//停止&戻る
#define SLEEPMOTER	SetPWM1(0); SetPWM2(0);			//全モーター停止
