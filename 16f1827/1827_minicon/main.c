...
//#define TURRETRIGHT	LATB2=1;	SetPWM2(225); 		//砲塔右へ
//#define TURRETLEFT	LATB2=0;	SetPWM2(225);		//砲塔左へ
//#define TIRERIGHT	LATB3=1;	SetPWM1(230);		//タイヤ右回転
//#define TIRELEFT	LATB3=0;	SetPWM1(230);		//タイヤ左回転
#define FIRE		LATB6=1;						//発射

#define TRANSAMRIGHT LATB3=1;	SetPWM1(1023);		//トランザム右
#define TRANSAMLEFT  LATB3=0;	SetPWM1(1023);		//トランザム左
